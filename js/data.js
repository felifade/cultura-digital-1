...
window.notebookData = {
  ...
  "semana03": {
    "title": "Ciudadanía e Identidad Digital",
    "dateRange": "14 - 18 Sep",
    "partial": 1,
    "visible": false,
    "hora1": "# Hora 1: Apertura\n\n**Objetivo:** Introducción al tema de Ciudadanía e Identidad Digital.\n\n### Actividad\nDinámica \"El rastro invisible\". Se muestran ejemplos de cómo una simple búsqueda en internet deja un rastro (cookies). Introducción al concepto de \"Huella Digital\".",
    "hora2": "# Hora 2: Desarrollo\n\n**Misión Principal:**\n\n\"Misión 3: Mi Huella Digital\". El alumno busca su propio nombre (o el de un adulto voluntario) en buscadores y analiza qué información es pública. En la segunda fase, realiza un taller guiado para configurar la Privacidad y Seguridad de su cuenta institucional (@dgb.edu.mx) y crear una contraseña segura usando una fórmula mnemotécnica.",
    "hora3": "# Hora 3: Cierre\n\n**Reflexión Final:**\nEl estudiante escribe un párrafo reflexivo sobre cómo cuidar su credencial de acceso escolar y los peligros del \"Phishing\".\n\n---\n\n## Evaluación\n- **Entregable:** Evidencia de seguridad configurada (Captura de pantalla recortada en Docs) y párrafo reflexivo.\n- **Instrumento:** Escala estimativa (Formativa y Actitudinal)",
    "productos": "### Productos de la semana\nEl profesor aún no ha publicado los productos de esta semana."
  },
  "semana04": {
    "title": "El modelo de negocio del internet",
    "dateRange": "21 - 25 Sep",
    "partial": 1,
    "visible": false,
